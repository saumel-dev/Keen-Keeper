...
React Router — Client-side routing & data loading  <br>
Tailwind CSS — Utility-first styling  <br>
Recharts — Interactive pie chart for stats  <br>
React Icons — Icon library  <br>
React Toastify — Toast notifications  <br>
